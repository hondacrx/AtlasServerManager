...
namespace AtlasServerManager
{
    public partial class FormMain : Form
    {
        ...
        private void PerformanceInfo_UpdateEvent(string memory, string cpu)
        {
            ...
            this.Invoke(() => lCpuPercent.Text = cpu);
        }
        ...
        private void bServers_Click(object sender, EventArgs e)
        {
            OpenChildForm(new FormServers());
        }

        private void bConfigEditor_Click(object sender, EventArgs e)
        {
            OpenChildForm(new FormConfigEditor());
        }
